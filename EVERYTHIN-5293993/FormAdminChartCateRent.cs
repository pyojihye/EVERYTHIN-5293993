...
{
    public partial class FormAdminChartCateRent : Form
    {
        FormMain mainform;
        DataTable categoryTable;

        public FormAdminChartCateRent(FormMain mainform)
        {
            InitializeComponent();
            this.mainform = mainform;
        }

        private void FormAdminChartCate_FormClosing(object sender, FormClosingEventArgs e)
        {
            Application.Exit();
        }
        ...
        private void FormAdminChartCate_Load(object sender, EventArgs e)
        {
